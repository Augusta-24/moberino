...
(function() {
  ...
  const BOSS_TUNING = {
    ...
    'MEAN TACO':    { rMult: 1.12, hpMult: 1.24, attackDelayMult: 0.82, projectileSpeedMult: 1.12, damageMult: 1.0, vulnerabilityWindowMult: 1.0, spawnClutterAllowed: false, signatureClutterAllowed: false, notes: 'Faster shield rhythm with extra HP to make the open windows matter.' },
    'COSMIC OCTO':  { rMult: 1.10, hpMult: 1.14, attackDelayMult: 1.0, projectileSpeedMult: 1.0, damageMult: 1.0, vulnerabilityWindowMult: 1.0, spawnClutterAllowed: false, signatureClutterAllowed: false, notes: 'Large target, with more HP because ink can steal player attack time.' },
