...
(function() {
  ...
  const BOSS_TUNING = {
    ...
    'GRAY VISITOR': { rMult: 0.58, hpMult: 0.68, attackDelayMult: 0.92, projectileSpeedMult: 1.04, damageMult: 1.0, vulnerabilityWindowMult: 1.15, spawnClutterAllowed: false, signatureClutterAllowed: false, notes: 'Small glitch boss. Player bullets must crack a shield relay; Gray attacks stay simple.' },
