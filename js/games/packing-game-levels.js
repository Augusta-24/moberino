...
(function () {
  ...
  const WORLDS = [
    ...
    },
    {
      ...
      name: 'Double Zones',
      displayName: 'Castle',
      description: 'Fill every glowing zone cell twice while filling the rest of the board once.',
      available: true,
      levels: [
        future('zone-01', 1, 'Second Layer', 'Fill the glowing three-cell zone twice and every other cell once.',
        ...
        future('zone-02', 2, 'Glow Chamber', 'Allocate all eleven pieces across a four-cell double zone.',
        ...
        future('zone-03', 3, 'Inner Keep', 'Pack through a connected five-cell double zone.',
